...
from ..models.make_tool_type import MakeToolType
...
class MakeTool:
    """
    Attributes:
        type_ (MakeToolType): The type of tool. "make" for Make tool.
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        make_tool.additional_properties = d
        return make_tool
