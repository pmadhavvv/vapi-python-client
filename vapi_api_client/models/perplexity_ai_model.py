...
from ..models.perplexity_ai_model_provider import PerplexityAIModelProvider
...
T = TypeVar("T", bound="PerplexityAIModel")
...
class PerplexityAIModel:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        provider = PerplexityAIModelProvider(d.pop("provider"))
        ...
        perplexity_ai_model.additional_properties = d
        return perplexity_ai_model
