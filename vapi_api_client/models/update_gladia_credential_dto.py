...
T = TypeVar("T", bound="UpdateGladiaCredentialDTO")
...
class UpdateGladiaCredentialDTO:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        update_gladia_credential_dto = cls(
            api_key=api_key,
            name=name,
        )

        update_gladia_credential_dto.additional_properties = d
        return update_gladia_credential_dto
