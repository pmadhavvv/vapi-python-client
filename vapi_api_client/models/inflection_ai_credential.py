...
from ..models.inflection_ai_credential_provider import InflectionAICredentialProvider
from ..types import UNSET, Unset

T = TypeVar("T", bound="InflectionAICredential")
...
class InflectionAICredential:
    """
    Attributes:
        provider (InflectionAICredentialProvider): This is the api key for Pi in InflectionAI's console. Get it from
            here: https://developers.inflection.ai/keys, billing will need to be setup
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        provider = InflectionAICredentialProvider(d.pop("provider"))
        ...
        inflection_ai_credential.additional_properties = d
        return inflection_ai_credential
