...
from ..models.groq_model_model import GroqModelModel
from ..models.groq_model_provider import GroqModelProvider
...
class GroqModel:
    """
    Attributes:
        model (GroqModelModel): This is the name of the model. Ex. cognitivecomputations/dolphin-mixtral-8x7b
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        model = GroqModelModel(d.pop("model"))

        provider = GroqModelProvider(d.pop("provider"))
        ...
        groq_model.additional_properties = d
        return groq_model
