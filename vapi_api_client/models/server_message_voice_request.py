...
from ..models.server_message_voice_request_type import ServerMessageVoiceRequestType
...
T = TypeVar("T", bound="ServerMessageVoiceRequest")
...
class ServerMessageVoiceRequest:
    """
    Attributes:
        type_ (ServerMessageVoiceRequestType): This is the type of the message. "voice-request" is sent when using
            ...
            ```
        text (str): This is the text to be synthesized.
        sample_rate (float): This is the sample rate to be synthesized.
    ...
    type_: ServerMessageVoiceRequestType
    text: str
    sample_rate: float
    phone_number: Union[
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = ServerMessageVoiceRequestType(d.pop("type"))
        ...
        server_message_voice_request = cls(
            type_=type_,
            text=text,
        ...
        server_message_voice_request.additional_properties = d
        return server_message_voice_request
