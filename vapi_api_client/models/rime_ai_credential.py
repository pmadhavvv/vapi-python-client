...
from ..models.rime_ai_credential_provider import RimeAICredentialProvider
from ..types import UNSET, Unset

T = TypeVar("T", bound="RimeAICredential")


@_attrs_define
class RimeAICredential:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        provider = RimeAICredentialProvider(d.pop("provider"))
        ...
        rime_ai_credential.additional_properties = d
        return rime_ai_credential
