...
from ..models.create_vonage_phone_number_dto_provider import CreateVonagePhoneNumberDTOProvider
...
T = TypeVar("T", bound="CreateVonagePhoneNumberDTO")
...
class CreateVonagePhoneNumberDTO:
    """
    Attributes:
        provider (CreateVonagePhoneNumberDTOProvider): This is to use numbers bought on Vonage.
    ...
    provider: CreateVonagePhoneNumberDTOProvider
    number: str
    credential_id: str
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        provider = CreateVonagePhoneNumberDTOProvider(d.pop("provider"))
        ...
        create_vonage_phone_number_dto = cls(
            provider=provider,
            number=number,
        ...
        create_vonage_phone_number_dto.additional_properties = d
        return create_vonage_phone_number_dto
