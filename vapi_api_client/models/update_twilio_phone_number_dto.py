...
T = TypeVar("T", bound="UpdateTwilioPhoneNumberDTO")
...
class UpdateTwilioPhoneNumberDTO:
    ...
    Attributes:
        ...
        number (Union[Unset, str]): These are the digits of the phone number you own on your Twilio.
        twilio_account_sid (Union[Unset, str]): This is the Twilio Account SID for the phone number.
        twilio_auth_token (Union[Unset, str]): This is the Twilio Auth Token for the phone number.
    """
    ...
    twilio_account_sid: Union[Unset, str] = UNSET
    twilio_auth_token: Union[Unset, str] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if twilio_account_sid is not UNSET:
            field_dict["twilioAccountSid"] = twilio_account_sid
        if twilio_auth_token is not UNSET:
            field_dict["twilioAuthToken"] = twilio_auth_token
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        twilio_account_sid = d.pop("twilioAccountSid", UNSET)

        twilio_auth_token = d.pop("twilioAuthToken", UNSET)

        update_twilio_phone_number_dto = cls(
        ...
        update_twilio_phone_number_dto.additional_properties = d
        return update_twilio_phone_number_dto
