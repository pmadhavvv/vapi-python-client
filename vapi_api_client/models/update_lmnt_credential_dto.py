...
T = TypeVar("T", bound="UpdateLmntCredentialDTO")
...
class UpdateLmntCredentialDTO:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        update_lmnt_credential_dto = cls(
            api_key=api_key,
            name=name,
        )

        update_lmnt_credential_dto.additional_properties = d
        return update_lmnt_credential_dto
