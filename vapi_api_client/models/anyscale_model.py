...
from ..models.anyscale_model_provider import AnyscaleModelProvider
...
T = TypeVar("T", bound="AnyscaleModel")
...
class AnyscaleModel:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        provider = AnyscaleModelProvider(d.pop("provider"))
        ...
        anyscale_model.additional_properties = d
        return anyscale_model
