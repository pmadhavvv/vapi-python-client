...
from ..models.query_tool_type import QueryToolType
...
class QueryTool:
    """
    Attributes:
        type_ (QueryToolType): The type of tool. "query" for Query tool.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = QueryToolType(d.pop("type"))
        ...
        query_tool.additional_properties = d
        return query_tool
