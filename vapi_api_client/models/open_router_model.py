...
from ..models.open_router_model_provider import OpenRouterModelProvider
...
T = TypeVar("T", bound="OpenRouterModel")
...
class OpenRouterModel:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        provider = OpenRouterModelProvider(d.pop("provider"))
        ...
        open_router_model.additional_properties = d
