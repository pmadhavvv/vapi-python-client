...
from ..models.create_output_tool_dto_type import CreateOutputToolDTOType
...
T = TypeVar("T", bound="CreateOutputToolDTO")
...
class CreateOutputToolDTO:
    """
    Attributes:
        type_ (CreateOutputToolDTOType): The type of tool. "output" for Output tool.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = CreateOutputToolDTOType(d.pop("type"))
        ...
        create_output_tool_dto.additional_properties = d
        return create_output_tool_dto
