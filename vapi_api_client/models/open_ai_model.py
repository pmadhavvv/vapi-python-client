...
from ..models.open_ai_model_fallback_models import OpenAIModelFallbackModels
from ..models.open_ai_model_model import OpenAIModelModel
from ..models.open_ai_model_provider import OpenAIModelProvider
...
class OpenAIModel:
    """
    Attributes:
        provider (OpenAIModelProvider): This is the provider that will be used for the model.
        model (OpenAIModelModel): This is the OpenAI model that will be used.
        ...
        fallback_models (Union[Unset, OpenAIModelFallbackModels]): These are the fallback models that will be used if
            the primary model fails. This shouldn't be specified unless you have a specific reason to do so. Vapi will
            automatically find the fastest fallbacks that make sense. Example: ['gpt-4-0125-preview', 'gpt-4-0613'].
    ...
    fallback_models: Union[Unset, OpenAIModelFallbackModels] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        fallback_models: Union[Unset, str] = UNSET
        if not isinstance(self.fallback_models, Unset):
            fallback_models = self.fallback_models.value
        ...
        if fallback_models is not UNSET:
            field_dict["fallbackModels"] = fallback_models
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        provider = OpenAIModelProvider(d.pop("provider"))

        model = OpenAIModelModel(d.pop("model"))
        ...
        _fallback_models = d.pop("fallbackModels", UNSET)
        fallback_models: Union[Unset, OpenAIModelFallbackModels]
        if isinstance(_fallback_models, Unset):
            fallback_models = UNSET
        else:
            fallback_models = OpenAIModelFallbackModels(_fallback_models)
        ...
        open_ai_model.additional_properties = d
