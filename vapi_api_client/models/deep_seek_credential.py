...
from ..models.deep_seek_credential_provider import DeepSeekCredentialProvider
from ..types import UNSET, Unset

T = TypeVar("T", bound="DeepSeekCredential")
...
class DeepSeekCredential:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        provider = DeepSeekCredentialProvider(d.pop("provider"))
        ...
        deep_seek_credential.additional_properties = d
        return deep_seek_credential
