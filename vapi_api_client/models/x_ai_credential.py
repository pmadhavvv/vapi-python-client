...
from ..models.x_ai_credential_provider import XAiCredentialProvider
from ..types import UNSET, Unset

T = TypeVar("T", bound="XAiCredential")
...
class XAiCredential:
    """
    Attributes:
        provider (XAiCredentialProvider): This is the api key for Grok in XAi's console. Get it from here:
            https://console.x.ai
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        d = src_dict.copy()
        provider = XAiCredentialProvider(d.pop("provider"))
        ...
        x_ai_credential.additional_properties = d
        return x_ai_credential
