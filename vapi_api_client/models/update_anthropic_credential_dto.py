...
T = TypeVar("T", bound="UpdateAnthropicCredentialDTO")
...
class UpdateAnthropicCredentialDTO:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_anthropic_credential_dto = cls(
            api_key=api_key,
            name=name,
        )

        update_anthropic_credential_dto.additional_properties = d
        return update_anthropic_credential_dto
