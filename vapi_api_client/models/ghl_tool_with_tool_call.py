...
from ..models.ghl_tool_with_tool_call_type import GhlToolWithToolCallType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.ghl_tool_metadata import GhlToolMetadata
...
T = TypeVar("T", bound="GhlToolWithToolCall")
...
class GhlToolWithToolCall:
    """
    Attributes:
        type_ (GhlToolWithToolCallType): The type of tool. "ghl" for GHL tool.
        tool_call (ToolCall):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = GhlToolWithToolCallType(d.pop("type"))

        tool_call = ToolCall.from_dict(d.pop("toolCall"))

        metadata = GhlToolMetadata.from_dict(d.pop("metadata"))
        ...
        ghl_tool_with_tool_call.additional_properties = d
        return ghl_tool_with_tool_call
