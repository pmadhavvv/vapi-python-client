...
from ..models.together_ai_credential_provider import TogetherAICredentialProvider
from ..types import UNSET, Unset

T = TypeVar("T", bound="TogetherAICredential")


@_attrs_define
class TogetherAICredential:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        d = src_dict.copy()
        provider = TogetherAICredentialProvider(d.pop("provider"))
        ...
        together_ai_credential.additional_properties = d
        return together_ai_credential
