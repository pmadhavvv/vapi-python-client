...
from ..models.smallest_ai_credential_provider import SmallestAICredentialProvider
from ..types import UNSET, Unset

T = TypeVar("T", bound="SmallestAICredential")
...
class SmallestAICredential:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        provider = SmallestAICredentialProvider(d.pop("provider"))
        ...
        smallest_ai_credential.additional_properties = d
        return smallest_ai_credential
