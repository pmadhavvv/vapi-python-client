...
from ..models.create_end_call_tool_dto_type import CreateEndCallToolDTOType
...
T = TypeVar("T", bound="CreateEndCallToolDTO")


@_attrs_define
class CreateEndCallToolDTO:
    """
    Attributes:
        type_ (CreateEndCallToolDTOType): The type of tool. "endCall" for End Call tool.
    ...
    type_: CreateEndCallToolDTOType
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        type_ = CreateEndCallToolDTOType(d.pop("type"))
        ...
        create_end_call_tool_dto.additional_properties = d
        return create_end_call_tool_dto
