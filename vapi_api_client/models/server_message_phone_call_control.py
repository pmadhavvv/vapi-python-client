...
from ..models.server_message_phone_call_control_request import ServerMessagePhoneCallControlRequest
from ..models.server_message_phone_call_control_type import ServerMessagePhoneCallControlType
...
T = TypeVar("T", bound="ServerMessagePhoneCallControl")
...
class ServerMessagePhoneCallControl:
    """
    Attributes:
        type_ (ServerMessagePhoneCallControlType): This is the type of the message. "phone-call-control" is an advanced
            type of message.

            When it is requested in `assistant.serverMessages`, the hangup and forwarding responsibilities are delegated to
            your server. Vapi will no longer do the actual transfer and hangup.
        request (ServerMessagePhoneCallControlRequest): This is the request to control the phone call.
        ...
        destination (Union['TransferDestinationNumber', 'TransferDestinationSip', Unset]): This is the destination to
            forward the call to if the request is "forward".
    ...
    type_: ServerMessagePhoneCallControlType
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        server_message_phone_call_control = cls(
            type_=type_,
            request=request,
        ...
        server_message_phone_call_control.additional_properties = d
        return server_message_phone_call_control
