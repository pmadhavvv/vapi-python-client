...
from ..models.dtmf_tool_type import DtmfToolType
...
class DtmfTool:
    """
    Attributes:
        type_ (DtmfToolType): The type of tool. "dtmf" for DTMF tool.
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        dtmf_tool.additional_properties = d
        return dtmf_tool
