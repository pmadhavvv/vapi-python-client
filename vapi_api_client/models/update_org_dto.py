...
from ..models.update_org_dto_channel import UpdateOrgDTOChannel
...
T = TypeVar("T", bound="UpdateOrgDTO")
...
class UpdateOrgDTO:
    ...
    Attributes:
        ...
        channel (Union[Unset, UpdateOrgDTOChannel]): This is the channel of the org. There is the cluster the API
    ...
    channel: Union[Unset, UpdateOrgDTOChannel] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        channel: Union[Unset, UpdateOrgDTOChannel]
        if isinstance(_channel, Unset):
            channel = UNSET
        else:
            channel = UpdateOrgDTOChannel(_channel)
        ...
        update_org_dto.additional_properties = d
        return update_org_dto
