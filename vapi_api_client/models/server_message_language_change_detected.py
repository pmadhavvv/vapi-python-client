...
from ..models.server_message_language_change_detected_type import ServerMessageLanguageChangeDetectedType
...
T = TypeVar("T", bound="ServerMessageLanguageChangeDetected")
...
class ServerMessageLanguageChangeDetected:
    """
    Attributes:
        type_ (ServerMessageLanguageChangeDetectedType): This is the type of the message. "language-change-detected" is
    ...
    type_: ServerMessageLanguageChangeDetectedType
    language: str
    phone_number: Union[
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        type_ = ServerMessageLanguageChangeDetectedType(d.pop("type"))
        ...
        server_message_language_change_detected = cls(
            type_=type_,
            language=language,
        ...
        server_message_language_change_detected.additional_properties = d
        return server_message_language_change_detected
