...
from ..models.assistant_overrides_background_sound import AssistantOverridesBackgroundSound
from ..models.assistant_overrides_client_messages import AssistantOverridesClientMessages
from ..models.assistant_overrides_first_message_mode import AssistantOverridesFirstMessageMode
from ..models.assistant_overrides_server_messages import AssistantOverridesServerMessages
...
if TYPE_CHECKING:
    ...
    from ..models.assistant_overrides_metadata import AssistantOverridesMetadata
    from ..models.assistant_overrides_variable_values import AssistantOverridesVariableValues
...
T = TypeVar("T", bound="AssistantOverrides")
...
class AssistantOverrides:
    ...
    Attributes:
        ...
        first_message_mode (Union[Unset, AssistantOverridesFirstMessageMode]): This is the mode for the first message.
        ...
        client_messages (Union[Unset, AssistantOverridesClientMessages]): These are the messages that will be sent to
            ...
            input'].
        server_messages (Union[Unset, AssistantOverridesServerMessages]): These are the messages that will be sent to
        ...
        background_sound (Union[Unset, AssistantOverridesBackgroundSound]): This is the background sound in the call.
        ...
        variable_values (Union[Unset, AssistantOverridesVariableValues]): These are values that will be used to replace
            the template variables in the assistant messages and other text-based fields.
            This uses LiquidJS syntax. https://liquidjs.com/tutorials/intro-to-liquid.html

            So for example, `{{ name }}` will be replaced with the value of `name` in `variableValues`.
            `{{"now" | date: "%b %d, %Y, %I:%M %p", "America/New_York"}}` will be replaced with the current date and time in
            New York.
        ...
        metadata (Union[Unset, AssistantOverridesMetadata]): This is for metadata you want to store on the assistant.
    ...
    first_message_mode: Union[Unset, AssistantOverridesFirstMessageMode] = UNSET
    voicemail_detection: Union[
        "GoogleVoicemailDetectionPlan", "OpenAIVoicemailDetectionPlan", "TwilioVoicemailDetectionPlan", Unset
    ] = UNSET
    client_messages: Union[Unset, AssistantOverridesClientMessages] = UNSET
    server_messages: Union[Unset, AssistantOverridesServerMessages] = UNSET
    silence_timeout_seconds: Union[Unset, float] = UNSET
    max_duration_seconds: Union[Unset, float] = UNSET
    background_sound: Union[Unset, AssistantOverridesBackgroundSound] = UNSET
    ...
    variable_values: Union[Unset, "AssistantOverridesVariableValues"] = UNSET
    ...
    metadata: Union[Unset, "AssistantOverridesMetadata"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        variable_values: Union[Unset, dict[str, Any]] = UNSET
        if not isinstance(self.variable_values, Unset):
            variable_values = self.variable_values.to_dict()
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        first_message_mode: Union[Unset, AssistantOverridesFirstMessageMode]
        if isinstance(_first_message_mode, Unset):
            first_message_mode = UNSET
        else:
            first_message_mode = AssistantOverridesFirstMessageMode(_first_message_mode)
        ...
        client_messages: Union[Unset, AssistantOverridesClientMessages]
        if isinstance(_client_messages, Unset):
            client_messages = UNSET
        else:
            client_messages = AssistantOverridesClientMessages(_client_messages)

        _server_messages = d.pop("serverMessages", UNSET)
        server_messages: Union[Unset, AssistantOverridesServerMessages]
        if isinstance(_server_messages, Unset):
            server_messages = UNSET
        else:
            server_messages = AssistantOverridesServerMessages(_server_messages)
        ...
        background_sound: Union[Unset, AssistantOverridesBackgroundSound]
        if isinstance(_background_sound, Unset):
            background_sound = UNSET
        else:
            background_sound = AssistantOverridesBackgroundSound(_background_sound)
        ...
        variable_values: Union[Unset, AssistantOverridesVariableValues]
        if isinstance(_variable_values, Unset):
            variable_values = UNSET
        else:
            variable_values = AssistantOverridesVariableValues.from_dict(_variable_values)
        ...
        metadata: Union[Unset, AssistantOverridesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = AssistantOverridesMetadata.from_dict(_metadata)
        ...
        assistant_overrides.additional_properties = d
