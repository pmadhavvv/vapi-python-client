...
T = TypeVar("T", bound="ImportTwilioPhoneNumberDTO")
...
class ImportTwilioPhoneNumberDTO:
    """
    Attributes:
        twilio_phone_number (str): These are the digits of the phone number you own on your Twilio.
        twilio_account_sid (str): This is your Twilio Account SID that will be used to handle this phone number.
        twilio_auth_token (str): This is the Twilio Auth Token that will be used to handle this phone number.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        twilio_phone_number = d.pop("twilioPhoneNumber")
        ...
        import_twilio_phone_number_dto = cls(
        ...
        import_twilio_phone_number_dto.additional_properties = d
        return import_twilio_phone_number_dto
