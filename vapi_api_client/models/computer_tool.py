...
from ..models.computer_tool_name import ComputerToolName
from ..models.computer_tool_sub_type import ComputerToolSubType
from ..models.computer_tool_type import ComputerToolType
...
T = TypeVar("T", bound="ComputerTool")
...
class ComputerTool:
    """
    Attributes:
        type_ (ComputerToolType): The type of tool. "computer" for Computer tool.
        sub_type (ComputerToolSubType): The sub type of tool.
        ...
        name (ComputerToolName): The name of the tool, fixed to 'computer'
    ...
    type_: ComputerToolType
    sub_type: ComputerToolSubType
    id: str
    org_id: str
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        name = ComputerToolName(d.pop("name"))
        ...
        computer_tool.additional_properties = d
