...
T = TypeVar("T", bound="UpdateAssemblyAICredentialDTO")
...
class UpdateAssemblyAICredentialDTO:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_assembly_ai_credential_dto = cls(
            api_key=api_key,
            name=name,
        )

        update_assembly_ai_credential_dto.additional_properties = d
        return update_assembly_ai_credential_dto
