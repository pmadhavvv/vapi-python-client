...
from ..models.vonage_phone_number_provider import VonagePhoneNumberProvider
from ..models.vonage_phone_number_status import VonagePhoneNumberStatus
...
T = TypeVar("T", bound="VonagePhoneNumber")
...
class VonagePhoneNumber:
    """
    Attributes:
        provider (VonagePhoneNumberProvider): This is to use numbers bought on Vonage.
        ...
        status (Union[Unset, VonagePhoneNumberStatus]): This is the status of the phone number.
    ...
    provider: VonagePhoneNumberProvider
    id: str
    org_id: str
    ...
    status: Union[Unset, VonagePhoneNumberStatus] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status: Union[Unset, VonagePhoneNumberStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = VonagePhoneNumberStatus(_status)
        ...
        vonage_phone_number.additional_properties = d
