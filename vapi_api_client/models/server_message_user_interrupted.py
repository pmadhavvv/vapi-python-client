...
from ..models.server_message_user_interrupted_type import ServerMessageUserInterruptedType
...
T = TypeVar("T", bound="ServerMessageUserInterrupted")
...
class ServerMessageUserInterrupted:
    """
    Attributes:
        type_ (ServerMessageUserInterruptedType): This is the type of the message. "user-interrupted" is sent when the
    ...
    type_: ServerMessageUserInterruptedType
    phone_number: Union[
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = ServerMessageUserInterruptedType(d.pop("type"))
        ...
        server_message_user_interrupted = cls(
            type_=type_,
        ...
        server_message_user_interrupted.additional_properties = d
        return server_message_user_interrupted
