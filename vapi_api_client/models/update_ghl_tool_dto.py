...
T = TypeVar("T", bound="UpdateGhlToolDTO")
...
class UpdateGhlToolDTO:
    ...
    Attributes:
        ...
        metadata (Union[Unset, GhlToolMetadata]):
    """
    ...
    metadata: Union[Unset, "GhlToolMetadata"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_metadata, Unset):
            ...
            metadata = GhlToolMetadata.from_dict(_metadata)

        update_ghl_tool_dto = cls(
            async_=async_,
            messages=messages,
            function=function,
            server=server,
        ...
        update_ghl_tool_dto.additional_properties = d
        return update_ghl_tool_dto
