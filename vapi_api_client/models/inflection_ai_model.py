...
from ..models.inflection_ai_model_model import InflectionAIModelModel
from ..models.inflection_ai_model_provider import InflectionAIModelProvider
...
T = TypeVar("T", bound="InflectionAIModel")


@_attrs_define
class InflectionAIModel:
    """
    Attributes:
        model (InflectionAIModelModel): This is the name of the model. Ex. cognitivecomputations/dolphin-mixtral-8x7b
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        model = InflectionAIModelModel(d.pop("model"))

        provider = InflectionAIModelProvider(d.pop("provider"))
        ...
        inflection_ai_model.additional_properties = d
        return inflection_ai_model
