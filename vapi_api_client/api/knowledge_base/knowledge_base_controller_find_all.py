...
) -> Optional[list[Union["CustomKnowledgeBase", "TrieveKnowledgeBase"]]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:

            def _parse_response_200_item(data: object) -> Union["CustomKnowledgeBase", "TrieveKnowledgeBase"]:
                try:
                    if not isinstance(data, dict):
                        raise TypeError()
                    response_200_item_type_0 = TrieveKnowledgeBase.from_dict(data)
                ...
                if not isinstance(data, dict):
                    raise TypeError()
                response_200_item_type_1 = CustomKnowledgeBase.from_dict(data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[list[Union["CustomKnowledgeBase", "TrieveKnowledgeBase"]]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        list[Union['CustomKnowledgeBase', 'TrieveKnowledgeBase']]
    """
