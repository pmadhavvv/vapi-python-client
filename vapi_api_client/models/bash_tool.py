...
from ..models.bash_tool_name import BashToolName
from ..models.bash_tool_sub_type import BashToolSubType
from ..models.bash_tool_type import BashToolType
...
class BashTool:
    """
    Attributes:
        type_ (BashToolType): The type of tool. "bash" for Bash tool.
        sub_type (BashToolSubType): The sub type of tool.
        ...
        name (BashToolName): The name of the tool, fixed to 'bash'
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = BashToolType(d.pop("type"))

        sub_type = BashToolSubType(d.pop("subType"))
        ...
        bash_tool.additional_properties = d
        return bash_tool
