...
from ..models.create_text_editor_tool_dto_name import CreateTextEditorToolDTOName
from ..models.create_text_editor_tool_dto_sub_type import CreateTextEditorToolDTOSubType
from ..models.create_text_editor_tool_dto_type import CreateTextEditorToolDTOType
...
T = TypeVar("T", bound="CreateTextEditorToolDTO")
...
class CreateTextEditorToolDTO:
    """
    Attributes:
        type_ (CreateTextEditorToolDTOType): The type of tool. "textEditor" for Text Editor tool.
        sub_type (CreateTextEditorToolDTOSubType): The sub type of tool.
        name (CreateTextEditorToolDTOName): The name of the tool, fixed to 'str_replace_editor'
    ...
    type_: CreateTextEditorToolDTOType
    sub_type: CreateTextEditorToolDTOSubType
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        type_ = CreateTextEditorToolDTOType(d.pop("type"))

        sub_type = CreateTextEditorToolDTOSubType(d.pop("subType"))

        name = CreateTextEditorToolDTOName(d.pop("name"))
        ...
        create_text_editor_tool_dto = cls(
            type_=type_,
            sub_type=sub_type,
            name=name,
            async_=async_,
        ...
        create_text_editor_tool_dto.additional_properties = d
        return create_text_editor_tool_dto
