...
from ..models.make_credential_provider import MakeCredentialProvider
from ..types import UNSET, Unset

T = TypeVar("T", bound="MakeCredential")
...
class MakeCredential:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        provider = MakeCredentialProvider(d.pop("provider"))
        ...
        make_credential.additional_properties = d
