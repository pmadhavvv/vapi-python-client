...
T = TypeVar("T", bound="UpdateCerebrasCredentialDTO")
...
class UpdateCerebrasCredentialDTO:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        update_cerebras_credential_dto = cls(
            api_key=api_key,
            name=name,
        )

        update_cerebras_credential_dto.additional_properties = d
        return update_cerebras_credential_dto
