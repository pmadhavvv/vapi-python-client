...
from ..models.update_computer_tool_dto_name import UpdateComputerToolDTOName
from ..models.update_computer_tool_dto_sub_type import UpdateComputerToolDTOSubType
...
T = TypeVar("T", bound="UpdateComputerToolDTO")
...
class UpdateComputerToolDTO:
    ...
    Attributes:
        ...
        sub_type (Union[Unset, UpdateComputerToolDTOSubType]): The sub type of tool.
        function (Union[Unset, OpenAIFunction]):
        server (Union[Unset, Server]):
        name (Union[Unset, UpdateComputerToolDTOName]): The name of the tool, fixed to 'computer'
        display_width_px (Union[Unset, float]): The display width in pixels
        display_height_px (Union[Unset, float]): The display height in pixels
    ...
    sub_type: Union[Unset, UpdateComputerToolDTOSubType] = UNSET
    function: Union[Unset, "OpenAIFunction"] = UNSET
    server: Union[Unset, "Server"] = UNSET
    name: Union[Unset, UpdateComputerToolDTOName] = UNSET
    display_width_px: Union[Unset, float] = UNSET
    display_height_px: Union[Unset, float] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if display_width_px is not UNSET:
            field_dict["displayWidthPx"] = display_width_px
        if display_height_px is not UNSET:
            field_dict["displayHeightPx"] = display_height_px
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sub_type: Union[Unset, UpdateComputerToolDTOSubType]
        if isinstance(_sub_type, Unset):
            sub_type = UNSET
        else:
            sub_type = UpdateComputerToolDTOSubType(_sub_type)
        ...
        name: Union[Unset, UpdateComputerToolDTOName]
        if isinstance(_name, Unset):
            name = UNSET
        else:
            name = UpdateComputerToolDTOName(_name)

        display_width_px = d.pop("displayWidthPx", UNSET)

        display_height_px = d.pop("displayHeightPx", UNSET)

        display_number = d.pop("displayNumber", UNSET)

        update_computer_tool_dto = cls(
            async_=async_,
            messages=messages,
            sub_type=sub_type,
            function=function,
        ...
        update_computer_tool_dto.additional_properties = d
        return update_computer_tool_dto
