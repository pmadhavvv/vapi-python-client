...
from ..models.function_tool_with_tool_call_type import FunctionToolWithToolCallType
...
T = TypeVar("T", bound="FunctionToolWithToolCall")
...
class FunctionToolWithToolCall:
    """
    Attributes:
        type_ (FunctionToolWithToolCallType): The type of tool. "function" for Function tool.
        tool_call (ToolCall):
    ...
    type_: FunctionToolWithToolCallType
    tool_call: "ToolCall"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = FunctionToolWithToolCallType(d.pop("type"))
        ...
        function_tool_with_tool_call = cls(
            type_=type_,
            tool_call=tool_call,
            async_=async_,
            messages=messages,
        ...
        function_tool_with_tool_call.additional_properties = d
        return function_tool_with_tool_call
