...
T = TypeVar("T", bound="UpdateCartesiaCredentialDTO")
...
class UpdateCartesiaCredentialDTO:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_cartesia_credential_dto = cls(
            api_key=api_key,
            name=name,
        )

        update_cartesia_credential_dto.additional_properties = d
        return update_cartesia_credential_dto
