...
from ..models.vapi_model_provider import VapiModelProvider
...
class VapiModel:
    ...
    Attributes:
        ...
        workflow_id (Union[Unset, str]): This is the workflow that will be used for the call. To use a transient
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        vapi_model.additional_properties = d
        return vapi_model
