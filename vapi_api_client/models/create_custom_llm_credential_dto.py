...
from ..models.create_custom_llm_credential_dto_provider import CreateCustomLLMCredentialDTOProvider
...
T = TypeVar("T", bound="CreateCustomLLMCredentialDTO")
...
class CreateCustomLLMCredentialDTO:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        provider = CreateCustomLLMCredentialDTOProvider(d.pop("provider"))
        ...
        create_custom_llm_credential_dto = cls(
            provider=provider,
            api_key=api_key,
        ...
        create_custom_llm_credential_dto.additional_properties = d
        return create_custom_llm_credential_dto
