...
from ..models.bash_tool_with_tool_call_name import BashToolWithToolCallName
from ..models.bash_tool_with_tool_call_sub_type import BashToolWithToolCallSubType
from ..models.bash_tool_with_tool_call_type import BashToolWithToolCallType
...
T = TypeVar("T", bound="BashToolWithToolCall")
...
class BashToolWithToolCall:
    """
    Attributes:
        type_ (BashToolWithToolCallType): The type of tool. "bash" for Bash tool.
        sub_type (BashToolWithToolCallSubType): The sub type of tool.
        tool_call (ToolCall):
        name (BashToolWithToolCallName): The name of the tool, fixed to 'bash'
    ...
    type_: BashToolWithToolCallType
    sub_type: BashToolWithToolCallSubType
    tool_call: "ToolCall"
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        type_ = BashToolWithToolCallType(d.pop("type"))

        sub_type = BashToolWithToolCallSubType(d.pop("subType"))

        tool_call = ToolCall.from_dict(d.pop("toolCall"))

        name = BashToolWithToolCallName(d.pop("name"))
        ...
        bash_tool_with_tool_call.additional_properties = d
        return bash_tool_with_tool_call
