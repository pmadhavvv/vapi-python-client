...
from ..models.trieve_credential_provider import TrieveCredentialProvider
from ..types import UNSET, Unset

T = TypeVar("T", bound="TrieveCredential")


@_attrs_define
class TrieveCredential:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        provider = TrieveCredentialProvider(d.pop("provider"))
        ...
        trieve_credential.additional_properties = d
        return trieve_credential
