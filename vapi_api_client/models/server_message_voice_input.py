...
from ..models.server_message_voice_input_type import ServerMessageVoiceInputType
...
T = TypeVar("T", bound="ServerMessageVoiceInput")
...
class ServerMessageVoiceInput:
    """
    Attributes:
        type_ (ServerMessageVoiceInputType): This is the type of the message. "voice-input" is sent when a generation is
    ...
    type_: ServerMessageVoiceInputType
    input_: str
    phone_number: Union[
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        type_ = ServerMessageVoiceInputType(d.pop("type"))
        ...
        server_message_voice_input = cls(
            type_=type_,
            input_=input_,
        ...
        server_message_voice_input.additional_properties = d
        return server_message_voice_input
