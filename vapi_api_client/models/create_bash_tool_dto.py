...
from ..models.create_bash_tool_dto_name import CreateBashToolDTOName
from ..models.create_bash_tool_dto_sub_type import CreateBashToolDTOSubType
from ..models.create_bash_tool_dto_type import CreateBashToolDTOType
...
T = TypeVar("T", bound="CreateBashToolDTO")


@_attrs_define
class CreateBashToolDTO:
    """
    Attributes:
        type_ (CreateBashToolDTOType): The type of tool. "bash" for Bash tool.
        sub_type (CreateBashToolDTOSubType): The sub type of tool.
        name (CreateBashToolDTOName): The name of the tool, fixed to 'bash'
    ...
    type_: CreateBashToolDTOType
    sub_type: CreateBashToolDTOSubType
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        type_ = CreateBashToolDTOType(d.pop("type"))

        sub_type = CreateBashToolDTOSubType(d.pop("subType"))

        name = CreateBashToolDTOName(d.pop("name"))
        ...
        create_bash_tool_dto.additional_properties = d
        return create_bash_tool_dto
