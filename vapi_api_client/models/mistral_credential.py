...
from ..models.mistral_credential_provider import MistralCredentialProvider
from ..types import UNSET, Unset

T = TypeVar("T", bound="MistralCredential")


@_attrs_define
class MistralCredential:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        provider = MistralCredentialProvider(d.pop("provider"))
        ...
        mistral_credential.additional_properties = d
        return mistral_credential
