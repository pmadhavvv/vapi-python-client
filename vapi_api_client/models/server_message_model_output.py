...
from ..models.server_message_model_output_type import ServerMessageModelOutputType
...
T = TypeVar("T", bound="ServerMessageModelOutput")
...
class ServerMessageModelOutput:
    """
    Attributes:
        type_ (ServerMessageModelOutputType): This is the type of the message. "model-output" is sent as the model
            outputs tokens.
        output (ServerMessageModelOutputOutput): This is the output of the model. It can be a token or tool call.
    ...
    type_: ServerMessageModelOutputType
    output: "ServerMessageModelOutputOutput"
    phone_number: Union[
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        server_message_model_output = cls(
            type_=type_,
            output=output,
        ...
        server_message_model_output.additional_properties = d
        return server_message_model_output
