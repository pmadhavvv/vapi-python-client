...
from ..models.open_ai_voicemail_detection_plan_provider import OpenAIVoicemailDetectionPlanProvider

T = TypeVar("T", bound="OpenAIVoicemailDetectionPlan")


@_attrs_define
class OpenAIVoicemailDetectionPlan:
    """
    Attributes:
        provider (OpenAIVoicemailDetectionPlanProvider): This is the provider to use for voicemail detection.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        provider = OpenAIVoicemailDetectionPlanProvider(d.pop("provider"))

        voicemail_expected_duration_seconds = d.pop("voicemailExpectedDurationSeconds")

        open_ai_voicemail_detection_plan = cls(
            provider=provider,
            voicemail_expected_duration_seconds=voicemail_expected_duration_seconds,
        )

        open_ai_voicemail_detection_plan.additional_properties = d
        return open_ai_voicemail_detection_plan
