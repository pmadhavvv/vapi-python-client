...
from ..models.create_tool_template_dto_provider import CreateToolTemplateDTOProvider
from ..models.create_tool_template_dto_type import CreateToolTemplateDTOType
from ..models.create_tool_template_dto_visibility import CreateToolTemplateDTOVisibility
...
T = TypeVar("T", bound="CreateToolTemplateDTO")
...
class CreateToolTemplateDTO:
    """
    Attributes:
        type_ (CreateToolTemplateDTOType):
        ...
        visibility (Union[Unset, CreateToolTemplateDTOVisibility]):
        name (Union[Unset, str]): The name of the template. This is just for your own reference.
        provider (Union[Unset, CreateToolTemplateDTOProvider]):
    """
    ...
    visibility: Union[Unset, CreateToolTemplateDTOVisibility] = UNSET
    name: Union[Unset, str] = UNSET
    provider: Union[Unset, CreateToolTemplateDTOProvider] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        type_ = CreateToolTemplateDTOType(d.pop("type"))
        ...
        if isinstance(_visibility, Unset):
            ...
            visibility = CreateToolTemplateDTOVisibility(_visibility)
        ...
        if isinstance(_provider, Unset):
            ...
            provider = CreateToolTemplateDTOProvider(_provider)

        create_tool_template_dto = cls(
            type_=type_,
            details=details,
        ...
        create_tool_template_dto.additional_properties = d
        return create_tool_template_dto
