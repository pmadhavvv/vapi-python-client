...
T = TypeVar("T", bound="UpdateTogetherAICredentialDTO")
...
class UpdateTogetherAICredentialDTO:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_together_ai_credential_dto = cls(
            api_key=api_key,
            name=name,
        )

        update_together_ai_credential_dto.additional_properties = d
        return update_together_ai_credential_dto
