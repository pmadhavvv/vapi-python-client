...
from ..models.template_provider import TemplateProvider
from ..models.template_type import TemplateType
from ..models.template_visibility import TemplateVisibility
...
class Template:
    ...
    Attributes:
        ...
        created_at (datetime.datetime): The ISO 8601 date-time string of when the template was created.
        updated_at (datetime.datetime): The ISO 8601 date-time string of when the template was last updated.
    ...
    visibility: Union[Unset, TemplateVisibility] = UNSET
    name: Union[Unset, str] = UNSET
    provider: Union[Unset, TemplateProvider] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_visibility, Unset):
            ...
            visibility = TemplateVisibility(_visibility)
        ...
        if isinstance(_provider, Unset):
            ...
            provider = TemplateProvider(_provider)
