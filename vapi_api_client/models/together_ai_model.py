...
from ..models.together_ai_model_provider import TogetherAIModelProvider
...
T = TypeVar("T", bound="TogetherAIModel")
...
class TogetherAIModel:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        provider = TogetherAIModelProvider(d.pop("provider"))
        ...
        together_ai_model.additional_properties = d
        return together_ai_model
