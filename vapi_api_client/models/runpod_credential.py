...
from ..models.runpod_credential_provider import RunpodCredentialProvider
from ..types import UNSET, Unset

T = TypeVar("T", bound="RunpodCredential")


@_attrs_define
class RunpodCredential:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        d = src_dict.copy()
        provider = RunpodCredentialProvider(d.pop("provider"))
        ...
        runpod_credential.additional_properties = d
        return runpod_credential
