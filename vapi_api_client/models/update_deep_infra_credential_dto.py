...
T = TypeVar("T", bound="UpdateDeepInfraCredentialDTO")
...
class UpdateDeepInfraCredentialDTO:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        update_deep_infra_credential_dto = cls(
            api_key=api_key,
            name=name,
        )

        update_deep_infra_credential_dto.additional_properties = d
        return update_deep_infra_credential_dto
