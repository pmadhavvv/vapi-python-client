...
from ..models.go_high_level_credential_provider import GoHighLevelCredentialProvider
from ..types import UNSET, Unset

T = TypeVar("T", bound="GoHighLevelCredential")


@_attrs_define
class GoHighLevelCredential:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        d = src_dict.copy()
        provider = GoHighLevelCredentialProvider(d.pop("provider"))
        ...
        go_high_level_credential.additional_properties = d
        return go_high_level_credential
