...
T = TypeVar("T", bound="UpdateQueryToolDTO")


@_attrs_define
class UpdateQueryToolDTO:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_query_tool_dto.additional_properties = d
        return update_query_tool_dto
