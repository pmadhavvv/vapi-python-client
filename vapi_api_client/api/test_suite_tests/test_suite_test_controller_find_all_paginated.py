...
from ...models.test_suite_test_controller_find_all_paginated_sort_order import (
    TestSuiteTestControllerFindAllPaginatedSortOrder,
)
from ...models.test_suite_tests_paginated_response import TestSuiteTestsPaginatedResponse
...
def _get_kwargs(
    ...
    *,
    ...
    sort_order: Union[Unset, TestSuiteTestControllerFindAllPaginatedSortOrder] = UNSET,
...
) -> Optional[TestSuiteTestsPaginatedResponse]:
    if response.status_code == 200:
        response_200 = TestSuiteTestsPaginatedResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[TestSuiteTestsPaginatedResponse]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        sort_order (Union[Unset, TestSuiteTestControllerFindAllPaginatedSortOrder]):
