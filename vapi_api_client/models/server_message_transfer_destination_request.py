...
from ..models.server_message_transfer_destination_request_type import ServerMessageTransferDestinationRequestType
...
T = TypeVar("T", bound="ServerMessageTransferDestinationRequest")


@_attrs_define
class ServerMessageTransferDestinationRequest:
    """
    Attributes:
        type_ (ServerMessageTransferDestinationRequestType): This is the type of the message. "transfer-destination-
            request" is sent when the model is requesting transfer but destination is unknown.
    ...
    type_: ServerMessageTransferDestinationRequestType
    phone_number: Union[
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = ServerMessageTransferDestinationRequestType(d.pop("type"))
        ...
        server_message_transfer_destination_request = cls(
            type_=type_,
        ...
        server_message_transfer_destination_request.additional_properties = d
        return server_message_transfer_destination_request
