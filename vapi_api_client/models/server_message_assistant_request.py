...
from ..models.server_message_assistant_request_type import ServerMessageAssistantRequestType
...
T = TypeVar("T", bound="ServerMessageAssistantRequest")
...
class ServerMessageAssistantRequest:
    """
    Attributes:
        type_ (ServerMessageAssistantRequestType): This is the type of the message. "assistant-request" is sent to fetch
    ...
    type_: ServerMessageAssistantRequestType
    phone_number: Union[
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        type_ = ServerMessageAssistantRequestType(d.pop("type"))
        ...
        server_message_assistant_request = cls(
            type_=type_,
        ...
        server_message_assistant_request.additional_properties = d
        return server_message_assistant_request
