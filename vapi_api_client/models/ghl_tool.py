...
from ..models.ghl_tool_type import GhlToolType
...
class GhlTool:
    """
    Attributes:
        type_ (GhlToolType): The type of tool. "ghl" for GHL tool.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ghl_tool.additional_properties = d
        return ghl_tool
