...
from ..models.create_function_tool_dto_type import CreateFunctionToolDTOType
...
T = TypeVar("T", bound="CreateFunctionToolDTO")
...
class CreateFunctionToolDTO:
    """
    Attributes:
        type_ (CreateFunctionToolDTOType): The type of tool. "function" for Function tool.
    ...
    type_: CreateFunctionToolDTOType
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = CreateFunctionToolDTOType(d.pop("type"))
        ...
        create_function_tool_dto.additional_properties = d
        return create_function_tool_dto
