...
from ..models.create_make_tool_dto_type import CreateMakeToolDTOType
...
T = TypeVar("T", bound="CreateMakeToolDTO")


@_attrs_define
class CreateMakeToolDTO:
    """
    Attributes:
        type_ (CreateMakeToolDTOType): The type of tool. "make" for Make tool.
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        create_make_tool_dto.additional_properties = d
        return create_make_tool_dto
