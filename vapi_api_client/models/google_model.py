...
from ..models.google_model_model import GoogleModelModel
from ..models.google_model_provider import GoogleModelProvider
...
if TYPE_CHECKING:
    ...
    from ..models.google_realtime_config import GoogleRealtimeConfig
    from ..models.open_ai_message import OpenAIMessage


T = TypeVar("T", bound="GoogleModel")
...
class GoogleModel:
    """
    Attributes:
        model (GoogleModelModel): This is the Google model that will be used.
        ...
        realtime_config (Union[Unset, GoogleRealtimeConfig]):
    ...
    realtime_config: Union[Unset, "GoogleRealtimeConfig"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        realtime_config: Union[Unset, dict[str, Any]] = UNSET
        if not isinstance(self.realtime_config, Unset):
            realtime_config = self.realtime_config.to_dict()
        ...
        if realtime_config is not UNSET:
            field_dict["realtimeConfig"] = realtime_config
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        model = GoogleModelModel(d.pop("model"))

        provider = GoogleModelProvider(d.pop("provider"))
        ...
        _realtime_config = d.pop("realtimeConfig", UNSET)
        realtime_config: Union[Unset, GoogleRealtimeConfig]
        if isinstance(_realtime_config, Unset):
            realtime_config = UNSET
        else:
            realtime_config = GoogleRealtimeConfig.from_dict(_realtime_config)
        ...
        google_model.additional_properties = d
        return google_model
