...
from ..models.cartesia_credential_provider import CartesiaCredentialProvider
from ..types import UNSET, Unset

T = TypeVar("T", bound="CartesiaCredential")


@_attrs_define
class CartesiaCredential:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        d = src_dict.copy()
        provider = CartesiaCredentialProvider(d.pop("provider"))
        ...
        cartesia_credential.additional_properties = d
        return cartesia_credential
