...
from ..models.google_credential_provider import GoogleCredentialProvider
from ..types import UNSET, Unset

T = TypeVar("T", bound="GoogleCredential")
...
class GoogleCredential:
    """
    Attributes:
        provider (GoogleCredentialProvider): This is the key for Gemini in Google AI Studio. Get it from here:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        provider = GoogleCredentialProvider(d.pop("provider"))
        ...
        google_credential.additional_properties = d
