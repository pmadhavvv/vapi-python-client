...
T = TypeVar("T", bound="UpdateGoogleCredentialDTO")
...
class UpdateGoogleCredentialDTO:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_google_credential_dto = cls(
            api_key=api_key,
            name=name,
        )

        update_google_credential_dto.additional_properties = d
        return update_google_credential_dto
