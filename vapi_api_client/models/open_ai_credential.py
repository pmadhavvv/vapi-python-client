...
from ..models.open_ai_credential_provider import OpenAICredentialProvider
from ..types import UNSET, Unset

T = TypeVar("T", bound="OpenAICredential")
...
class OpenAICredential:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        d = src_dict.copy()
        provider = OpenAICredentialProvider(d.pop("provider"))
        ...
        open_ai_credential.additional_properties = d
        return open_ai_credential
