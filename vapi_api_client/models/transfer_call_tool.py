...
from ..models.transfer_call_tool_type import TransferCallToolType
...
T = TypeVar("T", bound="TransferCallTool")
...
class TransferCallTool:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        type_ = TransferCallToolType(d.pop("type"))
        ...
        transfer_call_tool.additional_properties = d
        return transfer_call_tool
