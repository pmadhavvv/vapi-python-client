...
T = TypeVar("T", bound="UpdateMakeToolDTO")
...
class UpdateMakeToolDTO:
    ...
    Attributes:
        ...
        metadata (Union[Unset, MakeToolMetadata]):
    """
    ...
    metadata: Union[Unset, "MakeToolMetadata"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_metadata, Unset):
            ...
            metadata = MakeToolMetadata.from_dict(_metadata)

        update_make_tool_dto = cls(
            async_=async_,
            messages=messages,
            function=function,
            server=server,
        ...
        update_make_tool_dto.additional_properties = d
        return update_make_tool_dto
