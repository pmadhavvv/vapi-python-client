...
from ..models.deep_infra_credential_provider import DeepInfraCredentialProvider
from ..types import UNSET, Unset

T = TypeVar("T", bound="DeepInfraCredential")
...
class DeepInfraCredential:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        d = src_dict.copy()
        provider = DeepInfraCredentialProvider(d.pop("provider"))
        ...
        deep_infra_credential.additional_properties = d
        return deep_infra_credential
