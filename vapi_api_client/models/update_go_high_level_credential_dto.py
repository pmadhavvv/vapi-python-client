...
T = TypeVar("T", bound="UpdateGoHighLevelCredentialDTO")
...
class UpdateGoHighLevelCredentialDTO:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_go_high_level_credential_dto = cls(
            api_key=api_key,
            name=name,
        )

        update_go_high_level_credential_dto.additional_properties = d
        return update_go_high_level_credential_dto
