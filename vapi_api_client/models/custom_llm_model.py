...
from ..models.custom_llm_model_metadata_send_mode import CustomLLMModelMetadataSendMode
from ..models.custom_llm_model_provider import CustomLLMModelProvider
...
T = TypeVar("T", bound="CustomLLMModel")
...
class CustomLLMModel:
    """
    Attributes:
        provider (CustomLLMModelProvider): This is the provider that will be used for the model. Any service, including
        ...
        metadata_send_mode (Union[Unset, CustomLLMModelMetadataSendMode]): This determines whether metadata is sent in
            requests to the custom provider.

            - `off` will not send any metadata. payload will look like `{ messages }`
            - `variable` will send `assistant.metadata` as a variable on the payload. payload will look like `{ messages,
            metadata }`
            - `destructured` will send `assistant.metadata` fields directly on the payload. payload will look like `{
            messages, ...metadata }`
    ...
    metadata_send_mode: Union[Unset, CustomLLMModelMetadataSendMode] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        metadata_send_mode: Union[Unset, str] = UNSET
        if not isinstance(self.metadata_send_mode, Unset):
            metadata_send_mode = self.metadata_send_mode.value
        ...
        if metadata_send_mode is not UNSET:
            field_dict["metadataSendMode"] = metadata_send_mode
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        provider = CustomLLMModelProvider(d.pop("provider"))
        ...
        _metadata_send_mode = d.pop("metadataSendMode", UNSET)
        metadata_send_mode: Union[Unset, CustomLLMModelMetadataSendMode]
        if isinstance(_metadata_send_mode, Unset):
            metadata_send_mode = UNSET
        else:
            metadata_send_mode = CustomLLMModelMetadataSendMode(_metadata_send_mode)
        ...
        custom_llm_model.additional_properties = d
