...
from ..models.anthropic_model_model import AnthropicModelModel
from ..models.anthropic_model_provider import AnthropicModelProvider
...
T = TypeVar("T", bound="AnthropicModel")
...
class AnthropicModel:
    """
    Attributes:
        model (AnthropicModelModel): The specific Anthropic/Claude model that will be used.
        provider (AnthropicModelProvider): The provider identifier for Anthropic.
        ...
        thinking (Union[Unset, AnthropicThinkingConfig]):
    ...
    thinking: Union[Unset, "AnthropicThinkingConfig"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_thinking, Unset):
            ...
            thinking = AnthropicThinkingConfig.from_dict(_thinking)
        ...
        anthropic_model.additional_properties = d
