...
from ..models.create_ghl_tool_dto_type import CreateGhlToolDTOType
...
T = TypeVar("T", bound="CreateGhlToolDTO")
...
class CreateGhlToolDTO:
    """
    Attributes:
        type_ (CreateGhlToolDTOType): The type of tool. "ghl" for GHL tool.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = CreateGhlToolDTOType(d.pop("type"))
        ...
        create_ghl_tool_dto.additional_properties = d
        return create_ghl_tool_dto
