...
from ..models.text_editor_tool_with_tool_call_name import TextEditorToolWithToolCallName
from ..models.text_editor_tool_with_tool_call_sub_type import TextEditorToolWithToolCallSubType
from ..models.text_editor_tool_with_tool_call_type import TextEditorToolWithToolCallType
...
T = TypeVar("T", bound="TextEditorToolWithToolCall")
...
class TextEditorToolWithToolCall:
    """
    Attributes:
        type_ (TextEditorToolWithToolCallType): The type of tool. "textEditor" for Text Editor tool.
        sub_type (TextEditorToolWithToolCallSubType): The sub type of tool.
        tool_call (ToolCall):
        name (TextEditorToolWithToolCallName): The name of the tool, fixed to 'str_replace_editor'
    ...
    type_: TextEditorToolWithToolCallType
    sub_type: TextEditorToolWithToolCallSubType
    tool_call: "ToolCall"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = TextEditorToolWithToolCallType(d.pop("type"))

        sub_type = TextEditorToolWithToolCallSubType(d.pop("subType"))

        tool_call = ToolCall.from_dict(d.pop("toolCall"))

        name = TextEditorToolWithToolCallName(d.pop("name"))
        ...
        text_editor_tool_with_tool_call = cls(
            type_=type_,
            sub_type=sub_type,
            tool_call=tool_call,
            name=name,
        ...
        text_editor_tool_with_tool_call.additional_properties = d
        return text_editor_tool_with_tool_call
