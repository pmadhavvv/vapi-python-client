...
from ..models.cerebras_credential_provider import CerebrasCredentialProvider
from ..types import UNSET, Unset

T = TypeVar("T", bound="CerebrasCredential")
...
class CerebrasCredential:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        provider = CerebrasCredentialProvider(d.pop("provider"))
        ...
        cerebras_credential.additional_properties = d
        return cerebras_credential
