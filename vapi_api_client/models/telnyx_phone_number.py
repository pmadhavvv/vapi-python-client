...
from ..models.telnyx_phone_number_provider import TelnyxPhoneNumberProvider
from ..models.telnyx_phone_number_status import TelnyxPhoneNumberStatus
...
T = TypeVar("T", bound="TelnyxPhoneNumber")


@_attrs_define
class TelnyxPhoneNumber:
    """
    Attributes:
        provider (TelnyxPhoneNumberProvider): This is to use numbers bought on Telnyx.
        ...
        number (str): These are the digits of the phone number you own on your Telnyx.
        ...
        status (Union[Unset, TelnyxPhoneNumberStatus]): This is the status of the phone number.
    ...
    provider: TelnyxPhoneNumberProvider
    id: str
    org_id: str
    ...
    status: Union[Unset, TelnyxPhoneNumberStatus] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        provider = TelnyxPhoneNumberProvider(d.pop("provider"))
        ...
        status: Union[Unset, TelnyxPhoneNumberStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = TelnyxPhoneNumberStatus(_status)
        ...
        telnyx_phone_number.additional_properties = d
