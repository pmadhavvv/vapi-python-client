...
from ..models.open_router_credential_provider import OpenRouterCredentialProvider
from ..types import UNSET, Unset

T = TypeVar("T", bound="OpenRouterCredential")
...
class OpenRouterCredential:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        provider = OpenRouterCredentialProvider(d.pop("provider"))
        ...
        open_router_credential.additional_properties = d
        return open_router_credential
