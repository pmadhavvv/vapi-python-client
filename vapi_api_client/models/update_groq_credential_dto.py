...
T = TypeVar("T", bound="UpdateGroqCredentialDTO")
...
class UpdateGroqCredentialDTO:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_groq_credential_dto = cls(
            api_key=api_key,
            name=name,
        )

        update_groq_credential_dto.additional_properties = d
        return update_groq_credential_dto
