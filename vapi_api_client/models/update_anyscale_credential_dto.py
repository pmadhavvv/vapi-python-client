...
T = TypeVar("T", bound="UpdateAnyscaleCredentialDTO")
...
class UpdateAnyscaleCredentialDTO:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_anyscale_credential_dto = cls(
            api_key=api_key,
            name=name,
        )

        update_anyscale_credential_dto.additional_properties = d
        return update_anyscale_credential_dto
