...
from ..models.deep_seek_model_model import DeepSeekModelModel
from ..models.deep_seek_model_provider import DeepSeekModelProvider
...
T = TypeVar("T", bound="DeepSeekModel")
...
class DeepSeekModel:
    """
    Attributes:
        model (DeepSeekModelModel): This is the name of the model. Ex. cognitivecomputations/dolphin-mixtral-8x7b
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        model = DeepSeekModelModel(d.pop("model"))

        provider = DeepSeekModelProvider(d.pop("provider"))
        ...
        deep_seek_model.additional_properties = d
        return deep_seek_model
