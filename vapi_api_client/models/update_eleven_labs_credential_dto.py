...
T = TypeVar("T", bound="UpdateElevenLabsCredentialDTO")
...
class UpdateElevenLabsCredentialDTO:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_eleven_labs_credential_dto = cls(
            api_key=api_key,
            name=name,
        )

        update_eleven_labs_credential_dto.additional_properties = d
        return update_eleven_labs_credential_dto
