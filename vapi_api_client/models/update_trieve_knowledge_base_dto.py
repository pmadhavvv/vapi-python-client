...
T = TypeVar("T", bound="UpdateTrieveKnowledgeBaseDTO")
...
class UpdateTrieveKnowledgeBaseDTO:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        update_trieve_knowledge_base_dto = cls(
            name=name,
            search_plan=search_plan,
            create_plan=create_plan,
        )

        update_trieve_knowledge_base_dto.additional_properties = d
        return update_trieve_knowledge_base_dto
