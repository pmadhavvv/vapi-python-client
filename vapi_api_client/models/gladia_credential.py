...
from ..models.gladia_credential_provider import GladiaCredentialProvider
from ..types import UNSET, Unset

T = TypeVar("T", bound="GladiaCredential")


@_attrs_define
class GladiaCredential:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        d = src_dict.copy()
        provider = GladiaCredentialProvider(d.pop("provider"))
        ...
        gladia_credential.additional_properties = d
        return gladia_credential
