...
from ..models.neuphonic_credential_provider import NeuphonicCredentialProvider
from ..types import UNSET, Unset

T = TypeVar("T", bound="NeuphonicCredential")


@_attrs_define
class NeuphonicCredential:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        d = src_dict.copy()
        provider = NeuphonicCredentialProvider(d.pop("provider"))
        ...
        neuphonic_credential.additional_properties = d
        return neuphonic_credential
