...
T = TypeVar("T", bound="UpdateOpenRouterCredentialDTO")
...
class UpdateOpenRouterCredentialDTO:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_open_router_credential_dto = cls(
            api_key=api_key,
            name=name,
        )

        update_open_router_credential_dto.additional_properties = d
        return update_open_router_credential_dto
