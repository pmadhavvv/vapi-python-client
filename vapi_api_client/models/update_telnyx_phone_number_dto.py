...
T = TypeVar("T", bound="UpdateTelnyxPhoneNumberDTO")
...
class UpdateTelnyxPhoneNumberDTO:
    ...
    Attributes:
        ...
        number (Union[Unset, str]): These are the digits of the phone number you own on your Telnyx.
        credential_id (Union[Unset, str]): This is the credential you added in dashboard.vapi.ai/keys. This is used to
            configure the number to send inbound calls to Vapi, make outbound calls and do live call updates like transfers
            and hangups.
    """
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        update_telnyx_phone_number_dto = cls(
        ...
        update_telnyx_phone_number_dto.additional_properties = d
        return update_telnyx_phone_number_dto
