...
T = TypeVar("T", bound="UpdateTavusCredentialDTO")
...
class UpdateTavusCredentialDTO:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        update_tavus_credential_dto = cls(
            api_key=api_key,
            name=name,
        )

        update_tavus_credential_dto.additional_properties = d
        return update_tavus_credential_dto
