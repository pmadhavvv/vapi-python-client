...
T = TypeVar("T", bound="UpdateByoSipTrunkCredentialDTO")
...
class UpdateByoSipTrunkCredentialDTO:
    ...
    Attributes:
        ...
        gateways (Union[Unset, list['SipTrunkGateway']]): This is the list of SIP trunk's gateways.
    ...
    gateways: Union[Unset, list["SipTrunkGateway"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        update_byo_sip_trunk_credential_dto = cls(
            name=name,
            gateways=gateways,
        ...
        update_byo_sip_trunk_credential_dto.additional_properties = d
        return update_byo_sip_trunk_credential_dto
