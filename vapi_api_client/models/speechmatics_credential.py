...
from ..models.speechmatics_credential_provider import SpeechmaticsCredentialProvider
from ..types import UNSET, Unset

T = TypeVar("T", bound="SpeechmaticsCredential")


@_attrs_define
class SpeechmaticsCredential:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        provider = SpeechmaticsCredentialProvider(d.pop("provider"))
        ...
        speechmatics_credential.additional_properties = d
        return speechmatics_credential
