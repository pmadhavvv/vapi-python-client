...
T = TypeVar("T", bound="UpdateWebhookCredentialDTO")
...
class UpdateWebhookCredentialDTO:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        update_webhook_credential_dto = cls(
            authentication_plan=authentication_plan,
            name=name,
        )

        update_webhook_credential_dto.additional_properties = d
        return update_webhook_credential_dto
