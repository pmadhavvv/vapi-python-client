...
from ..models.xai_model_model import XaiModelModel
from ..models.xai_model_provider import XaiModelProvider
...
class XaiModel:
    """
    Attributes:
        model (XaiModelModel): This is the name of the model. Ex. cognitivecomputations/dolphin-mixtral-8x7b
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        xai_model.additional_properties = d
        return xai_model
