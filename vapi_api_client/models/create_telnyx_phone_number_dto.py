...
from ..models.create_telnyx_phone_number_dto_provider import CreateTelnyxPhoneNumberDTOProvider
...
T = TypeVar("T", bound="CreateTelnyxPhoneNumberDTO")


@_attrs_define
class CreateTelnyxPhoneNumberDTO:
    """
    Attributes:
        provider (CreateTelnyxPhoneNumberDTOProvider): This is to use numbers bought on Telnyx.
    ...
    provider: CreateTelnyxPhoneNumberDTOProvider
    number: str
    credential_id: str
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        provider = CreateTelnyxPhoneNumberDTOProvider(d.pop("provider"))
        ...
        create_telnyx_phone_number_dto = cls(
            provider=provider,
            number=number,
        ...
        create_telnyx_phone_number_dto.additional_properties = d
        return create_telnyx_phone_number_dto
