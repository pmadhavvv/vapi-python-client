...
from ..models.tavus_credential_provider import TavusCredentialProvider
from ..types import UNSET, Unset

T = TypeVar("T", bound="TavusCredential")
...
class TavusCredential:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        provider = TavusCredentialProvider(d.pop("provider"))
        ...
        tavus_credential.additional_properties = d
        return tavus_credential
