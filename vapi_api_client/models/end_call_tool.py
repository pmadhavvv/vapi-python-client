...
from ..models.end_call_tool_type import EndCallToolType
...
class EndCallTool:
    """
    Attributes:
        type_ (EndCallToolType): The type of tool. "endCall" for End Call tool.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = EndCallToolType(d.pop("type"))
        ...
        end_call_tool.additional_properties = d
