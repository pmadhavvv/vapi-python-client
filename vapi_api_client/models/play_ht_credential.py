...
from ..models.play_ht_credential_provider import PlayHTCredentialProvider
from ..types import UNSET, Unset

T = TypeVar("T", bound="PlayHTCredential")
...
class PlayHTCredential:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        d = src_dict.copy()
        provider = PlayHTCredentialProvider(d.pop("provider"))
        ...
        play_ht_credential.additional_properties = d
        return play_ht_credential
