...
from ..models.perplexity_ai_credential_provider import PerplexityAICredentialProvider
from ..types import UNSET, Unset

T = TypeVar("T", bound="PerplexityAICredential")


@_attrs_define
class PerplexityAICredential:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        provider = PerplexityAICredentialProvider(d.pop("provider"))
        ...
        perplexity_ai_credential.additional_properties = d
        return perplexity_ai_credential
