...
from ..models.server_message_knowledge_base_request_type import ServerMessageKnowledgeBaseRequestType
...
T = TypeVar("T", bound="ServerMessageKnowledgeBaseRequest")
...
class ServerMessageKnowledgeBaseRequest:
    """
    Attributes:
        type_ (ServerMessageKnowledgeBaseRequestType): This is the type of the message. "knowledge-base-request" is sent
            to request knowledge base documents. To enable, use `assistant.knowledgeBase.provider=custom-knowledge-base`.
        messages_open_ai_formatted (list['OpenAIMessage']): This is just `messages` formatted for OpenAI.
        ...
        messages (Union[Unset, list[Union['BotMessage', 'SystemMessage', 'ToolCallMessage', 'ToolCallResultMessage',
            'UserMessage']]]): These are the messages that are going to be sent to the `model` right after the `knowledge-
            base-request` webhook completes.
    ...
    type_: ServerMessageKnowledgeBaseRequestType
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = ServerMessageKnowledgeBaseRequestType(d.pop("type"))
        ...
        server_message_knowledge_base_request = cls(
            type_=type_,
        ...
        server_message_knowledge_base_request.additional_properties = d
        return server_message_knowledge_base_request
