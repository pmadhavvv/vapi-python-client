...
from ..models.create_query_tool_dto_type import CreateQueryToolDTOType
...
T = TypeVar("T", bound="CreateQueryToolDTO")
...
class CreateQueryToolDTO:
    """
    Attributes:
        type_ (CreateQueryToolDTOType): The type of tool. "query" for Query tool.
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        knowledge_bases: Union[Unset, list[dict[str, Any]]] = UNSET
        if not isinstance(self.knowledge_bases, Unset):
            knowledge_bases = []
        ...
        if knowledge_bases is not UNSET:
            field_dict["knowledgeBases"] = knowledge_bases
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        knowledge_bases = []
        _knowledge_bases = d.pop("knowledgeBases", UNSET)
        for knowledge_bases_item_data in _knowledge_bases or []:
            knowledge_bases_item = KnowledgeBase.from_dict(knowledge_bases_item_data)
        ...
        create_query_tool_dto.additional_properties = d
        return create_query_tool_dto
