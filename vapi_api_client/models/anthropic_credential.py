...
from ..models.anthropic_credential_provider import AnthropicCredentialProvider
from ..types import UNSET, Unset

T = TypeVar("T", bound="AnthropicCredential")
...
class AnthropicCredential:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        d = src_dict.copy()
        provider = AnthropicCredentialProvider(d.pop("provider"))
        ...
        anthropic_credential.additional_properties = d
        return anthropic_credential
