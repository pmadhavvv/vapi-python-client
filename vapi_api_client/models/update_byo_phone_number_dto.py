...
T = TypeVar("T", bound="UpdateByoPhoneNumberDTO")
...
class UpdateByoPhoneNumberDTO:
    ...
    Attributes:
        ...
        credential_id (Union[Unset, str]): This is the credential of your own SIP trunk or Carrier (type `byo-sip-
            trunk`) which can be used to make calls to this phone number.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_byo_phone_number_dto = cls(
        ...
        update_byo_phone_number_dto.additional_properties = d
        return update_byo_phone_number_dto
