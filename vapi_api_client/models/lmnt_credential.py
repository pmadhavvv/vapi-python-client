...
from ..models.lmnt_credential_provider import LmntCredentialProvider
from ..types import UNSET, Unset

T = TypeVar("T", bound="LmntCredential")


@_attrs_define
class LmntCredential:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        d = src_dict.copy()
        provider = LmntCredentialProvider(d.pop("provider"))
        ...
        lmnt_credential.additional_properties = d
        return lmnt_credential
