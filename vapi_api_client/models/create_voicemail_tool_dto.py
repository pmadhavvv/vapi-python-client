...
from ..models.create_voicemail_tool_dto_type import CreateVoicemailToolDTOType
...
T = TypeVar("T", bound="CreateVoicemailToolDTO")
...
class CreateVoicemailToolDTO:
    """
    Attributes:
        type_ (CreateVoicemailToolDTOType): The type of tool. "voicemail". This uses the model itself to determine if a
            voicemil was reached. Can be used alternatively/alongside with TwilioVoicemailDetection
    ...
    type_: CreateVoicemailToolDTOType
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = CreateVoicemailToolDTOType(d.pop("type"))
        ...
        create_voicemail_tool_dto.additional_properties = d
        return create_voicemail_tool_dto
