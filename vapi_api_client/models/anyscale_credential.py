...
from ..models.anyscale_credential_provider import AnyscaleCredentialProvider
from ..types import UNSET, Unset

T = TypeVar("T", bound="AnyscaleCredential")


@_attrs_define
class AnyscaleCredential:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        provider = AnyscaleCredentialProvider(d.pop("provider"))
        ...
        anyscale_credential.additional_properties = d
        return anyscale_credential
