...
from ..models.server_message_hang_type import ServerMessageHangType
...
T = TypeVar("T", bound="ServerMessageHang")
...
class ServerMessageHang:
    """
    Attributes:
        type_ (ServerMessageHangType): This is the type of the message. "hang" is sent when the assistant is hanging due
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        type_ = ServerMessageHangType(d.pop("type"))
        ...
        server_message_hang.additional_properties = d
        return server_message_hang
