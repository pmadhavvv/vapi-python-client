...
from ..models.update_text_editor_tool_dto_name import UpdateTextEditorToolDTOName
from ..models.update_text_editor_tool_dto_sub_type import UpdateTextEditorToolDTOSubType
...
T = TypeVar("T", bound="UpdateTextEditorToolDTO")
...
class UpdateTextEditorToolDTO:
    ...
    Attributes:
        ...
        sub_type (Union[Unset, UpdateTextEditorToolDTOSubType]): The sub type of tool.
        function (Union[Unset, OpenAIFunction]):
        server (Union[Unset, Server]):
        name (Union[Unset, UpdateTextEditorToolDTOName]): The name of the tool, fixed to 'str_replace_editor'
    """
    ...
    sub_type: Union[Unset, UpdateTextEditorToolDTOSubType] = UNSET
    function: Union[Unset, "OpenAIFunction"] = UNSET
    server: Union[Unset, "Server"] = UNSET
    name: Union[Unset, UpdateTextEditorToolDTOName] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sub_type: Union[Unset, UpdateTextEditorToolDTOSubType]
        if isinstance(_sub_type, Unset):
            sub_type = UNSET
        else:
            sub_type = UpdateTextEditorToolDTOSubType(_sub_type)
        ...
        name: Union[Unset, UpdateTextEditorToolDTOName]
        if isinstance(_name, Unset):
            name = UNSET
        else:
            name = UpdateTextEditorToolDTOName(_name)

        update_text_editor_tool_dto = cls(
            async_=async_,
            messages=messages,
            sub_type=sub_type,
            function=function,
        ...
        update_text_editor_tool_dto.additional_properties = d
        return update_text_editor_tool_dto
