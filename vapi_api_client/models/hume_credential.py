...
from ..models.hume_credential_provider import HumeCredentialProvider
from ..types import UNSET, Unset

T = TypeVar("T", bound="HumeCredential")


@_attrs_define
class HumeCredential:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        provider = HumeCredentialProvider(d.pop("provider"))
        ...
        hume_credential.additional_properties = d
        return hume_credential
