...
from ..models.assembly_ai_credential_provider import AssemblyAICredentialProvider
from ..types import UNSET, Unset

T = TypeVar("T", bound="AssemblyAICredential")


@_attrs_define
class AssemblyAICredential:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        provider = AssemblyAICredentialProvider(d.pop("provider"))
        ...
        assembly_ai_credential.additional_properties = d
        return assembly_ai_credential
