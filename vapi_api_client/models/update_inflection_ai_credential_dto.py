...
T = TypeVar("T", bound="UpdateInflectionAICredentialDTO")
...
class UpdateInflectionAICredentialDTO:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_inflection_ai_credential_dto = cls(
            api_key=api_key,
            name=name,
        )

        update_inflection_ai_credential_dto.additional_properties = d
        return update_inflection_ai_credential_dto
