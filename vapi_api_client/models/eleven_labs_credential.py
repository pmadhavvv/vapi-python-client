...
from ..models.eleven_labs_credential_provider import ElevenLabsCredentialProvider
from ..types import UNSET, Unset

T = TypeVar("T", bound="ElevenLabsCredential")


@_attrs_define
class ElevenLabsCredential:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        provider = ElevenLabsCredentialProvider(d.pop("provider"))
        ...
        eleven_labs_credential.additional_properties = d
        return eleven_labs_credential
