...
from ..models.update_token_dto_tag import UpdateTokenDTOTag
...
T = TypeVar("T", bound="UpdateTokenDTO")
...
class UpdateTokenDTO:
    """
    Attributes:
        tag (Union[Unset, UpdateTokenDTOTag]): This is the tag for the token. It represents its scope.
    ...
    tag: Union[Unset, UpdateTokenDTOTag] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        tag: Union[Unset, UpdateTokenDTOTag]
        if isinstance(_tag, Unset):
            tag = UNSET
        else:
            tag = UpdateTokenDTOTag(_tag)
        ...
        update_token_dto = cls(
            tag=tag,
            name=name,
            restrictions=restrictions,
        )

        update_token_dto.additional_properties = d
        return update_token_dto
