...
T = TypeVar("T", bound="UpdateTransferCallToolDTO")
...
class UpdateTransferCallToolDTO:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_transfer_call_tool_dto = cls(
            async_=async_,
            messages=messages,
        ...
        update_transfer_call_tool_dto.additional_properties = d
        return update_transfer_call_tool_dto
