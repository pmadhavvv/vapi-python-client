...
from ..models.cerebras_model_model import CerebrasModelModel
from ..models.cerebras_model_provider import CerebrasModelProvider
...
T = TypeVar("T", bound="CerebrasModel")
...
class CerebrasModel:
    """
    Attributes:
        model (CerebrasModelModel): This is the name of the model. Ex. cognitivecomputations/dolphin-mixtral-8x7b
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        model = CerebrasModelModel(d.pop("model"))

        provider = CerebrasModelProvider(d.pop("provider"))
        ...
        cerebras_model.additional_properties = d
