...
T = TypeVar("T", bound="UpdateVonagePhoneNumberDTO")
...
class UpdateVonagePhoneNumberDTO:
    ...
    Attributes:
        ...
        number (Union[Unset, str]): These are the digits of the phone number you own on your Vonage.
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        update_vonage_phone_number_dto = cls(
        ...
        update_vonage_phone_number_dto.additional_properties = d
        return update_vonage_phone_number_dto
